...
def train_model(model, tokenizer, tokenized_dataset, save_dir):
    ...
    for epoch in range(epochs):
        ...
        print(f"Weight change norms for epoch {epoch+1}: {weight_change_norms}")
...
def main(finetune_files, model_name, step_list, save_name, model_dim):
    ...
    for step in step_list:
        ...
        weight_changes, perplexities = train_model(model, tokenizer, tokenized_dataset, save_dir)
